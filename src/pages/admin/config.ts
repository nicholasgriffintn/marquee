...
export const ACTION_GROUPS: {
  ...
  },
  {
    ...
    actions: [
      ...
      { id: "filming-locations", label: "Place filming locations" },
      { id: "world-board", label: "Measure other languages" },
...
export const COUNT_LABELS: { key: string; label: string }[] = [
  ...
  { key: "titleAwards", label: "titles with awards" },
  { key: "personAwards", label: "people with awards" },
  { key: "letterboxdIds", label: "Letterboxd ids" },
  { key: "visualFormat", label: "colour or ratio recorded" },
  { key: "placedTitles", label: "titles placed on the ground" },
  { key: "adaptedTitles", label: "titles linked to a source work" },
  { key: "worldBoards", label: "titles read in other languages" },
