...
export function WorldBoard({ titleId }: { titleId: string }) {
  ...
  return (
    <div className="detail-world">
      ...
      <small>
        A language is not a country — reading the French article does not put anyone in France. Only
        the ten largest Wikipedia editions and the title&rsquo;s original language are measured, and
        an edition needs 50 readers in the week to appear here.
