CREATE TABLE users (
  ...
  email TEXT,
  alert_email TEXT,
  alert_email_verified_at TIMESTAMPTZ
);
...
CREATE TABLE api_tokens (
  ...
  scopes TEXT NOT NULL DEFAULT 'catalogue:read shelf:read shelf:write people:follow account:full'
);
...
CREATE INDEX alert_email_tokens_viewer_idx ON alert_email_tokens (viewer_id);
